...
if [ -n "$SSH_CLIENT" ] || [ -n "$SSH_TTY" ]; then
  ...
  POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(os_icon user dir virtualenv vcs dir_writable)
fi
POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(status root_indicator battery custom_now_playing time public_ip ip disk_usage)
