...
plugins=(git docker docker-compose bundler cap command-not-found composer coffee debian gem git-extras knife ruby rvm sudo zsh-syntax-highlighting zsh-completions)
